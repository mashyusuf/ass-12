...
const DiscountProductsSlider = () => {
    const axiosSecure = useAxiosSecure(); // Initialize axiosSecure here
    ...
    const { data: discountedProducts, error, isLoading } = useQuery({ queryKey: ['discountedProducts'], queryFn: fetchDiscountedProducts });
